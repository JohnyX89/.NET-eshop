...
{
    [Area("Admin")]
    [Authorize(Roles = nameof(Roles.Admin))]         // just admin have authorization to OrderItems
    public class OrderItemsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var eshopList = eshopDBContext.ToList();
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ProductID"] = new SelectList(_context.Products, "ID", "Content");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderID,ProductID,Amount,Price,ID,DateTimeCreated")] OrderItem orderItem)
        {
            ...
            ViewData["ProductID"] = new SelectList(_context.Products, "ID", "Content", orderItem.ProductID);
            return View(orderItem);
        }
